...
export default function Chatbot() {
  ...
  const userId = useRef(
    localStorage.getItem("chat_user") || "user_" + Date.now(),
  );
  ...
  return (
    <>
      <div className="navbar">💬Chatbot Demo</div>
      ...
      {open && (
        ...
        >
          <header>
            ...
            <span className="cancel" onClick={() => setOpen(false)}>
              ✖
            </span>
          </header>
      ...
      <div className="watermark">Built by Harshit • 💬ChatBot Demo</div>
    </>
  );
}
